...
class SingleAudio extends React.Component {
  ...
  <article className="row format-audio">
    ...
    <div className="s-content__media col-full">
      <div className="s-content__post-thumb">
        <img src="images/thumbs/single/audio/audio-1000.jpg" srcSet="images/thumbs/single/audio/audio-2000.jpg 2000w, 
                          images/thumbs/single/audio/audio-1000.jpg 1000w, 
                          images/thumbs/single/audio/audio-500.jpg 500w" sizes="(max-width: 2000px) 100vw, 2000px" alt />
        <div className="audio-wrap">
          <audio id="player2" src="media/AirReview-Landmarks-02-ChasingCorporate.mp3" width="100%" height={42} controls="controls" />
        </div>
      </div>
