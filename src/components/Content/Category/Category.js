      ...
      <section className="s-content">
        <div className="row narrow">
          <div className="col-full s-content__header" data-aos="fade-up">
            ...
            <p className="lead">Dolor similique vitae. Exercitationem quidem occaecati iusto. Id non vitae enim quas error dolor maiores ut. Exercitationem earum ut repudiandae optio veritatis animi nulla qui dolores.</p>
          </div>
        </div>
